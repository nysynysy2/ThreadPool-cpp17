...
std::shared_future<std::involk_result<Fn,Args...>::type> add_task(Fn func, Args&&... args)
std::shared_future<std::involk_result<Fn,Args...>::type> add_task_delay(size_t delay_ms, Fn func, Args&&... args)
